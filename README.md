...
- התחברות בפייסבוק / אינסטגרם (הרשאת חברים) ועמוד **שיאים**: מדינה, עולם, חברים.
...
בלי App ID אפשר להתחבר מקומית כדי לראות את לוח השיאים. קהילת השיאים ב־[`data/records.json`](data/records.json).
